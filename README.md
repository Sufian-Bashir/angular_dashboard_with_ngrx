...
- effects , and entities can be improved
- can use fascade
- code coverage and more unit tests can be written for now i have just written to show sample unit tests
- workspaces and enhanced structure is possible.
- many improvements in code are possible i have done many things in a very simple and quick manner ofcourse we could do in many ways
